...
* A점과 경계 길이의 기준점을 중심으로 설정값에 따라 턴합니다.
...
* AB 커브 라인의 기준점을 중심으로 설정값에 따라 턴합니다.
...
![](../../.gitbook/assets/icon-square-2-2.svg) 턴 패턴 미리보기

* 현재 설정된 턴 패턴이 실제 작업 라인에 어떻게 적용되는지 미리 확인할 수 있습니다.

![](../../.gitbook/assets/icon-square-3.svg) 행 건너뛰기

* 턴 시 건너뛸 행(골)의 개수를 설정합니다.

![](../../.gitbook/assets/icon-square-4.svg) 최소 회전 반경

* 턴할 때의 최소 회전 반경을 설정합니다.

![](../../.gitbook/assets/icon-square-5.svg) 시작 방향
...
{% step %}
턴 경로가 생성되면![](../../.gitbook/assets/drive-button.svg)\[자율주행] 버튼을 눌러 턴이 포함된 자율주행을 시작합니다.
...
![](../../.gitbook/assets/icon-square-3.svg) R턴
...
![](../../.gitbook/assets/icon-square-4.svg) U턴
...
![](../../.gitbook/assets/icon-square-5.svg) 확장턴
...
* 버튼을 누르면 현재 설정한 턴 형태를 지도 상에서 미리 확인할 수 있습니다.
