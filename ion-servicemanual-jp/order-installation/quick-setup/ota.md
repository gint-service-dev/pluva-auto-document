...
{% hint style="info" %}
ソフトウェアアップデートは、Wi-Fi環境で行うことを推奨します。
{% endhint %}

{% hint style="info" %}
ネットワークが「セルラー」に設定してある場合は、\[ネットワーク変更]から切り替えることができます。
{% endhint %}
{% endstep %}
