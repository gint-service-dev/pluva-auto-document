...
&#x20;![](../../.gitbook/assets/icon-square-3-3.svg) **リセット**

* 圃場の調整を進める前の初期状態に復元します。

&#x20;![](../../.gitbook/assets/icon-square-4-4.svg)  **終了する**

* 圃場の調整画面を終了します。

&#x20;![](../../.gitbook/assets/icon-square-5-5.svg) **進入・退出口の変更**

* 進入・退出口の位置を変更します。このボタンを選択するか、進入・退出口のアイコンをタップすると移動可能な状態に切り替わります。
* 進入口と退出口が異なる位置に設定されている場合は、それぞれのボタンが表示されます。

&#x20;![](../../.gitbook/assets/icon-square-6-6.svg) **境界の調整完了**
