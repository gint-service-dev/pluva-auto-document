...
![](../../.gitbook/assets/icon-square-15.svg) **재생 속도**
...
* 지도에 작업의 주행 궂적이 표시됩니다. 시작 지점(S)·종료 지점(E)과 색상·아이콘의 의미는 경로 범례에서 확인합니다.

![](../../.gitbook/assets/icon-square-5.svg) **경로 범례**

* 지도에 표시된 경로 색상·아이콘의 의미를 확인합니다.

![](../../.gitbook/assets/icon-square-6.svg) **상세 정보**

* 해당 작업의 요약 정보(작업 정보) 패널을 엽니다.

![](../../.gitbook/assets/icon-square-7.svg) **실시간 데이터**

* 재생 시점을 기준으로 RTK 품질, 속도 등 상세 수치를 표시합니다.

![](../../.gitbook/assets/icon-square-8.svg) **재생 / 타임라인**

* \[▶]로 작업을 재생하고, 타임라인에서 특정 시점으로 이동합니다.

![](../../.gitbook/assets/icon-square-9.svg) **재생 속도**
