...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/8Sqfw92xyQ8XV1LQEpTt/undefined-1/network-settings/enter-network
---
...
&#x20;![](<../../.gitbook/assets/icon-square-2 (1).svg>) **위성 신호**
...
&#x20;![](<../../.gitbook/assets/icon-square-3 (1).svg>) **위치 보정**

* RTK 직접 수신/RTK 블루투스 등 보정 방식과 연결 방법을 설정합니다.\
  자세한 내용은 [위치 보정](rtk-setting.md)을 참고하세요.

&#x20;![](<../../.gitbook/assets/icon-square-4 (1).svg>) **네트워크**
