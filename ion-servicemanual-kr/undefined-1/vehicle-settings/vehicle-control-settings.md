...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/8Sqfw92xyQ8XV1LQEpTt/undefined-1/vehicle-settings/vehicle-control-settings
---
...
![](<../../.gitbook/assets/icon-square-3 (1).svg>) **전진 최저 속도 조건**
...
&#x20;![](<../../.gitbook/assets/icon-square-3 (1).svg>)  **후진 최저 속도 조건**
...
![](<../../.gitbook/assets/icon-square-3 (1).svg>)  **조향 민감도**
...
![](<../../.gitbook/assets/icon-square-4 (1).svg>)  **곡률 반경 제한**
