...
자동 AB 라인 생성은 등록된 필드 기준으로 간격과 여유 구간 등을 작업 상황에 맞게 자동으로 생성합니다.\
필드 안에서 별도로 이동하며 AB를 찍지 않아도 빠르게 작업 라인을 생성할 수 있으며,\
현재 위치에서 즉시 라인을 구성할 수 있어 준비 시간을 단축하고, 빠른 작업 시작을 지원합니다.
