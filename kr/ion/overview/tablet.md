...
* 작업기 상태를 실시간으로 모니터링하는 카메라 뷰입니다. 후방 작업기를 확인하여 안전하고 정확한 작업을 지원합니다. 자세한 내용은 개요-카메라를 참고해주세요.

![](../../.gitbook/assets/icon-circle-15.svg) 시스템 상태

* 화면 최상단에 표시되며, 작업에 필요한 핵심 시스템 정보를 실시간으로 제공합니다.\
  자세한 내용은 시스템 상태 아이콘을 참고해주세요.
