...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/Pt5o7wgXBzTKHnr0VazS/order-installation/product-installation/electric-steering-wheel
---
...
{% columns %}
{% column width="66.66666666666666%" %}
#### 5. 取り外したステアリング軸にスプラインを結合させ、ガタつきがないか確認する
...
{% columns %}
{% column width="66.66666666666666%" %}
#### **6.** 同梱のボルト(M4x8ボルト 6EA)を使ってスプラインとオートステアリングを結合させる
...
{% columns %}
{% column width="66.66666666666666%" %}
#### **8.** 同梱のボルト(M5x10/2EA)でフロントブラケットを固定する
