...
<figure><img src="../.gitbook/assets/3-4. 차량 정보 입력 (1).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}

{% step %}
**차량 정보를 입력하고 \[다음]을 누른다.**

<figure><img src="../.gitbook/assets/3-4. 차량 정보 입력 (2).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
>
> <img src="../.gitbook/assets/3-4. 차량 정보 입력 (3).png" alt="" data-size="original">
...
<figure><img src="../.gitbook/assets/3-4. 차량 치수입력 (1).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}

{% step %}
**좌우 스와이프로 다음 항목을 선택한다.**

<figure><img src="../.gitbook/assets/3-4. 차량 치수입력 (2).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}

{% step %}
**모든 치수를 입력하고 \[다음]을 누른다.**

<figure><img src="../.gitbook/assets/3-4. 차량 치수입력 (3).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<figure><img src="../.gitbook/assets/3-4. 메인컨트롤러 설치 위치 입력 (1).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}

{% step %}
**좌우 스와이프로 다음 항목을 선택한다.**

<figure><img src="../.gitbook/assets/3-4. 메인컨트롤러 설치 위치 입력 (2).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}

{% step %}
**모든 값을 입력하고 \[다음]을 누른다.**

<figure><img src="../.gitbook/assets/3-4. 메인컨트롤러 설치 위치 입력 (3).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<figure><img src="../.gitbook/assets/3-4. IMU 초기값 입력 (4).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<figure><img src="../.gitbook/assets/3-4. 작업기 정보 및 치수 입력 (1).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}

{% step %}
**안내에 따라 필요한 값을 입력하고 \[다음]을 누른다.**

<figure><img src="../.gitbook/assets/3-4. 작업기 정보 및 치수 입력 (2).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<figure><img src="../.gitbook/assets/3-4. 입력한 정보 확인 (1).png" alt="" width="371"><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<figure><img src="../.gitbook/assets/3-4. 입력한 정보 확인 (2).png" alt=""><figcaption></figcaption></figure>
