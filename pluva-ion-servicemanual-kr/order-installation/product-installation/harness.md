...
{% columns %}
{% column width="83.33333333333334%" %}
**12. 스티어링 모터 커넥터를 모터에 수평으로 맞춰 결합합니다.**

<figure><img src="../../.gitbook/assets/how-install-harness-12.png" alt=""><figcaption></figcaption></figure>

{% hint style="warning" %}
**스티어링 모터 커넥터 체결 시 주의 사항**

* 체결하기 전에 Male 커넥터의 핀이 휘거나 꺾이지 않았는지 육안으로 확인해 주세요.
* 핀이 가볍게 휘었다면 롱로우즈 또는 핀셋으로 조심스럽게 조정한 후 체결해 주세요.
* 핀이 심하게 꺾여 조정 과정에서 손상될 우려가 있다면 조정하지 말고 해당 커넥터를 교체해 주세요.
* 커넥터를 비스듬하게 삽입하면 핀이나 하우징이 손상될 수 있습니다. 방향을 맞춘 후 수평으로 체결해 주세요.
{% endhint %}
{% endcolumn %}
