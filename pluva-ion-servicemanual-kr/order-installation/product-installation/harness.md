...
* 모터 커넥터의 가이드 방향에 맞춰 삽입 해주세요.

![](<../../.gitbook/assets/image (67).png>)



* 연결 전 Male 커넥터의 핀이 휘거나 꺾이지 않았는지 확인하세요.
* 핀이 살짝 휘었으면 롱노즈나 핀셋으로 조심히 펴세요. 심하게 꺾였으면 커넥터를 교체하세요.
* 방향을 맞춰 수평으로 연결하세요. 비스듬히 끼우면 핀이나 하우징이 손상될 수 있습니다.
{% endhint %}
{% endcolumn %}
