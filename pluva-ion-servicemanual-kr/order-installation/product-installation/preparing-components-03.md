...
<div align="left"><figure><img src="../../.gitbook/assets/electric-steering-wheel-description-japan-kr.png" alt=""><figcaption></figcaption></figure></div>
...
\[자율주행 버튼]은 **경로 점 찍기**와 **자율주행 시작(ON/OFF)** 두 가지만 수행합니다. 모드에 필요한 점을 모두 찍기 전까지는 점을 순서대로 생성하고, 다 찍은 뒤에는 자율주행 ON/OFF로 전환됩니다.
