...
* 계정 상세 화면 하단에서 **작업, 제품, 장비, 작업, 설치, 원격 지원** 탭을 선택하여 각 이력을 조회합니다.\
  목록 조회만 가능하며, 직접 추가·수정은 지원하지 않습니다.
  * 작업탭: 고객이 작업한 내역을 확인합니다.
    * **작업 카드**: 작업 차량, 작업 시간, 작업 경로가 표시됩니다.
    * 또한 해당 작업의 상세 내용 확인이 가능합니다.
  ...
  * 원격 지원 탭: 이 고객/기기에 원격 지원을 언제, 몇 번 했는지 확인합니다.
    * **기간 설정**: 이번달, 최근 6개월, 최근 1년을 선택하면 기간 내 이력이 표시됩니다.
    * **이력 카드**: 기기별 원격 지원 이력이 표시됩니다.
...
* 계정 상세 화면 하단에서 **작업, 제품, 장비, 필드, 설치, 원격 지원** 탭을 선택하여 각 이력을 조회합니다.\
  ...
  *   장비 탭: 고객이 보유한 장비 정보를 확인합니다.
      ...
      * 등록된 차량 및 작업기 목록과 총 수량이 표시되며 클릭하여 상세 정보를 확인할 수 있습니다.
      ...
      <div align="left"><figure><img src="../../.gitbook/assets/image (116).png" alt="" width="188"><figcaption></figcaption></figure></div>
