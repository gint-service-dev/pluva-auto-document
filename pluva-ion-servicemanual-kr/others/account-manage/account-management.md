...
* 계정 상세 화면 하단에서 **작업, 제품, 장비, 필드, 설치, 원격 지원** 탭을 선택하여 각 이력을 조회합니다. 목록 조회만 가능하며, 직접 추가·수정은 지원하지 않습니다.
  ...
  *   장비 탭: 고객이 보유한 장비 정보를 확인합니다.
      ...
      * 등록된 차량 및 작업기 목록과 총 수량이 표시되며 클릭하여 상세 정보를 확인할 수 있습니다.

      <figure><img src="../../.gitbook/assets/image (119).png" alt=""><figcaption></figcaption></figure>
  * 필드 탭: 고객의 작업 관련 이력을 확인합니다.
    * 등록된 필드 목록과 총 수량이 표시됩니다.
  * 설치 탭: 고객의 설치 이력을 확인합니다.
    * 완료된 설치 작업 목록과 총 건수가 표시됩니다.
...
* 계정 상세 화면 하단에서 **작업, 제품, 장비, 필드, 설치, 원격 지원** 탭을 선택하여 각 이력을 조회합니다.\
  ...
  *   장비 탭: 고객이 보유한 장비 정보를 확인합니다.
      ...
      * 등록된 차량 및 작업기 목록과 총 수량이 표시되며 클릭하여 상세 정보를 확인할 수 있습니다.
      ...
      <div align="left"><figure><img src="../../.gitbook/assets/image (116).png" alt="" width="375"><figcaption></figcaption></figure></div>
  * 필드 탭: 고객의 작업 관련 이력을 확인합니다.
    * 등록된 필드 목록과 총 수량이 표시됩니다.
  * 설치 탭: 고객의 설치 이력을 확인합니다.
    * 완료된 설치 작업 목록과 총 건수가 표시됩니다.
