...
설치 결과는 "누구에게·어떤 제품을·어떤 차량에·언제 설치했는가"를 확인하는 메뉴입니다. 설치 티켓을 완료 처리한 후 확인할 수 있으며 현장 내용을 텍스트, 사진, 영상으로 입력해 기록할 수 있습니다.

{% hint style="info" %}
설치 티켓이 '완료' 상태로 확인되는 건만 표시됩니다. 설치는 했으나 티켓을 완료 처리하지 않은 건은 목록에 표시되지 않습니다.
{% endhint %}
...
{% hint style="info" %}
현장 기록은 설치 결과가 생성된 후 입력·업로드할 수 있으며, 작성·업로드한 사람과 일시가 함께 기록됩니다. 설치 담당자가 아니어도 입력할 수 있고, 작성자 본인만 수정할 수 있습니다.
{% endhint %}
...
* 태블릿 시리얼 번호가 표시됩니다.
* Expansion Kit의 경우 설치 시 연결된 태블릿 시리얼 번호가 표시됩니다.
...
차량 정보 드롭다운을 펼치면 차량 치수와 설치 당시 보정값을 확인할 수 있습니다.
...
![](../.gitbook/assets/icon-square-3.svg) **품목**
...
![](../.gitbook/assets/icon-square-6.svg) **차량 정보**

* 설치 차량의 타입, 제조사, 모델이 표시됩니다.
