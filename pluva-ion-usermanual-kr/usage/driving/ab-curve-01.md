...
<figure><img src="../../.gitbook/assets/ab-curve-1-japan-kr.png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
원하는 곡선을 그리며 25m 이상 주행한 뒤 \[B] 버튼을 눌러 B 지점을 생성합니다.

<figure><img src="../../.gitbook/assets/ab-curve-2-japan-kr.png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
<img src="../../.gitbook/assets/drive-button.svg" alt="" data-size="original">\[자율주행 시작] 버튼을 눌러 주행을 시작합니다.

<figure><img src="../../.gitbook/assets/ab-curve-3-japan-kr.png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
#### **1. 스마트커브 라인 생성시 유의 사항**

* **스마트커브 기준 라인은 되도록 길게 설정하세요.**
  * 주행 라인은 커브 라인을 기준으로 일정한 간격을 두고 나란히 생성되므로, 커브 라인이 길수록 더 많은 주행 라인을 확보하여 넓은 구역을 한 번에 작업할 수 있습니다.
* **스마트커브 기준 라인은 곡선이 더 크게 휘어진 면을 따라 생성하세요.**
  * 스마트커브 라인은 좌우 어느 면을 기준으로도 생성할 수 있으나, 더 휘어진 면일수록 곡선 라인을 따르는 주행 라인을 더 많이 만들 수 있습니다.

{% hint style="info" %}
커브 라인 곡률에 따른 주행 라인 생성 예시
...
* 스마트커브는 <mark style="color:$primary;">퀵턴이 꺼진 상태에서만</mark> 사용할 수 있습니다.
* 퀵턴이 켜진 채로 스마트커브 모드에 진입하면 "스마트커브모드 퀵턴 OFF 안내" 창이 표시됩니다.

<img src="../../.gitbook/assets/ab-curve-speed-quickturn-japan-kr.png" alt="" data-size="original">
...
<img src="../../.gitbook/assets/ab-curve-speed-3-japan-kr.png" alt="" data-size="original">
...
* 속도 초과로 인해 설정 경로를 **30cm 이상** 벗어나면 화면에 경고가 표시됩니다.

<img src="../../.gitbook/assets/ab-curve-speed-1-japan-kr.png" alt="" data-size="original">
...
<img src="../../.gitbook/assets/ab-curve-speed-2-japan-kr.png" alt="" data-size="original">
{% endhint %}
