...
{% stepper %}
{% step %}
홈 화면에서 ![](<../.gitbook/assets/ic_menu (1).svg>) 버튼을 누릅니다.
...
<figure><img src="../.gitbook/assets/report-menu-2 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
![](<../.gitbook/assets/icon-square-2 (1).svg>) **날짜 선택**
...
![](<../.gitbook/assets/icon-square-3 (1).svg>) **작업 시간**

* 작업 시작·종료 시각입니다.

![](<../.gitbook/assets/icon-square-4 (1).svg>) **자동 경로 표시**

* 자동 경로로 작업된 이력에 태그로 자동 경로를 표시합니다.

![](<../.gitbook/assets/icon-square-5 (1).svg>) **차량**
...
![](<../.gitbook/assets/icon-square-7 (1).svg>) **작업 소요시간**

* 실제 작업에 걸린 시간입니다.

![](<../.gitbook/assets/icon-square-8 (1).svg>) **작업 면적**
...
![](<../.gitbook/assets/icon-square-1 (1).svg>) **작업 시간**

* 작업 시작·종료 시각입니다.

![](<../.gitbook/assets/icon-square-2 (1).svg>) **작업 지도**
...
![](<../.gitbook/assets/icon-square-3 (1).svg>) **작업 면적**

* 자율주행으로 완료된 총 작업 면적입니다.

![](<../.gitbook/assets/icon-square-4 (1).svg>) **주행 거리**

* 작업 주행 합산 거리를 표시합니다. 자동·수동 거리도 함께 표시합니다.

![](<../.gitbook/assets/icon-square-5 (1).svg>) **작업 시간 정보**

* 작업시간은 자율주행 또는 수동으로 실제 작업을 수행한 총 시간입니다.
* 작업이 이루어진 시간대(오전작업 / 오후작업)가 함께 표시됩니다.

![](<../.gitbook/assets/icon-square-6 (1).svg>) **메모**

* 작업 시 입력한 메모를 확인합니다.

![](<../.gitbook/assets/icon-square-7 (1).svg>) **차량**

* 작업에 사용한 차량 정보입니다

![](<../.gitbook/assets/icon-square-8 (1).svg>) **작업기**
