...
![](<../../.gitbook/assets/icon-square-2 (1).svg>) **롤·피치·요 측정**

* 차량의 기울기(롤/피치/요)를 측정·보정합니다.

![](<../../.gitbook/assets/icon-square-3 (1).svg>) **오토스티어 보정**

* 차량이 흔들리지 않고 정확하게 직진하도록 조향을 보정합니다.

![](<../../.gitbook/assets/icon-square-4 (1).svg>) **차량 제어 설정**

* 작업 환경에 맞게 주행 특성을 조정합니다.\
  설정 변경은 자율주행 성능에 영향을 줄 수 있습니다.

![](<../../.gitbook/assets/icon-square-5 (1).svg>) **관성센서 초기화**

* 관성센서(IMU) 값을 초기 상태로 되돌립니다.

![](<../../.gitbook/assets/icon-square-6 (1).svg>) **내 차량**

* \[내 차량 ›]을 누르면 이전에 등록한 차량 목록이 표시됩니다.

<img src="../../.gitbook/assets/my-vehicle-list-1.png" alt="" data-size="original">

![](<../../.gitbook/assets/icon-square-7 (1).svg>) **차량 정보**

* 현재 장착된 차량의 타입, 별칭, 브랜드, 모델을 보여 줍니다.

![](<../../.gitbook/assets/icon-square-8 (1).svg>) **퀵턴 켜기/끄기**

* 퀵턴 설정 ON/OFF 상태를 표시합니다. 퀵턴 차량이 아닌 경우에는 표시되지 않습니다.

![](<../../.gitbook/assets/icon-square-9 (1).svg>) **차량 치수**

*   차량 치수 입력 완료 여부를 표시합니다. 선택 시 차량 치수를 수정할 수 있습니다.<br>
...
![](../../.gitbook/assets/icon-square-11.svg) **차량 추가 (+)**

* 화면 우측 하단의 + 버튼으로 새 차량을 추가합니다.
