...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/S9QxvkgOCtdmIoYhCUqg/usage/vehicle-settings/entering-my-vehicle
---
...
![](../../.gitbook/assets/icon-square-1.svg) **차량 보정**

* 차량이 흔들리거나 휘어지지 않고 정확하게 직진하도록 오토스티어, 롤/피치/요,\
  관성센서 등을 보정합니다.

![](../../.gitbook/assets/icon-square-2.svg) **차량 제어 설정**

* 작업 환경에 맞게 주행 특성을 조정합니다.\
  설정 변경은 자율주행 성능에 영향을 줄 수 있습니다.

![](../../.gitbook/assets/icon-square-3.svg) **GNSS 수신기 설정**

* 차량에 설치된 GNSS 수신기의 위치를 입력하여 위치 정확도를 최적화합니다.

![](../../.gitbook/assets/icon-square-4.svg) **차량 정보**
