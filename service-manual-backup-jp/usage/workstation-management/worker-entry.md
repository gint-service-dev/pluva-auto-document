...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/S9QxvkgOCtdmIoYhCUqg/usage/workstation-management/worker-entry
---
...
![](../../.gitbook/assets/icon-square-1.svg) **장착 중인 작업기**

* 현재 장착중인 작업기를 표시합니다.

![](../../.gitbook/assets/icon-square-2.svg) **목록 보기**
...
![](../../.gitbook/assets/icon-square-3.svg) **작업기 3D**

* 등록된 작업기를 3D로 표시합니다.

![](../../.gitbook/assets/icon-square-4.svg) **작업기 정보**

* 작업기 타입, 별칭 등 작업기 추가시 입력했던 정보가 표시됩니다.

![](../../.gitbook/assets/icon-square-5.svg) **상세 보기**

* 작업기 너비, 편차 등 작업기의 세부 정보들을 볼 수 있습니다.

![](../../.gitbook/assets/icon-square-6.svg) **작업기 추가 버튼**
