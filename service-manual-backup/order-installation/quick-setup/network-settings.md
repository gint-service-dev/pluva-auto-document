...
셀룰러(LTE)는 태블릿에 삽입된 유심(USIM)을 통해 이동통신망으로 인터넷에 연결하는 방식입니다.

{% hint style="info" %}
셀룰러(LTE)는 연결이 안정적이므로, 실시간 보정 신호가 필요한 정밀 작업에는 셀룰러(LTE) 사용을 권장합니다.
{% endhint %}
...
{% hint style="info" %}
셀룰러(LTE) 설정은 USIM을 태블릿에 장착된 상태에만 설정이 가능합니다.
{% endhint %}
...
| 정상 | 미연결 시 |
|---|---|
| <img src="../../.gitbook/assets/quick-setup-cellular_LTE.svg" alt="" data-size="line"> 셀룰러(LTE) 아이콘 표시 및 서버/RTK 연결 정상 동작 | <img src="../../.gitbook/assets/quick-setup-cellular-bad.svg" alt="" data-size="line"> 신호 없음 표시 → 2단계 진행 |
{% endstep %}
...
| 정상 | 미연결 시 |
|---|---|
| <img src="../../.gitbook/assets/quick-setup-cellular_LTE.svg" alt="" data-size="line"> 셀룰러(LTE) 연결 아이콘 표시 | <img src="../../.gitbook/assets/quick-setup-cellular-bad.svg" alt="" data-size="line"> 신호 없음 표시 → 3단계 진행 |
{% endstep %}
...
1.  **USIM 정상 여부 확인**
    ...
    휴대폰에서도 연결 안 됨 → USIM 불량 가능성이 높으므로 통신사에 문의하거나 USIM을 교체합니다.
...
| 정상 | 미연결 시 |
|---|---|
| <img src="../../.gitbook/assets/quick-setup-cellular_LTE.svg" alt="" data-size="line"> 셀룰러(LTE) 연결 정상 표시 | <img src="../../.gitbook/assets/quick-setup-cellular-bad.svg" alt="" data-size="line"> 신호 없음 표시 → 4단계 진행 |
{% endstep %}
