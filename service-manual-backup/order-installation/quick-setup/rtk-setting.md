...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/HCwHYcTtOkjeZoSlrD77/order-installation/quick-setup/rtk-setting
---
...
{% hint style="warning" %}
동일한 작업 구역 내에서는 하나의 기준(네트워크 RTK 또는 특정 베이스 스테이션)만을 선택하여 운용하세요. 혼용할 경우 위치 오차가 발생할 수 있습니다.
{% endhint %}
