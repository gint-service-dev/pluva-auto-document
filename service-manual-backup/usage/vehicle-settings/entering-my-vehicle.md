...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/HCwHYcTtOkjeZoSlrD77/usage/vehicle-settings/entering-my-vehicle
---
...
&#x20;![](../../.gitbook/assets/icon-square-4-4.svg) **차량 정보**

* 현재 장착된 차량의 타입, 별칭, 브랜드, 모델을 보여줍니다.

&#x20;![](../../.gitbook/assets/icon-square-5-5.svg) **배속턴 ON/OFF**

* 배속턴 차량의 배속턴 설정 ON/OFF 상태를 표시합니다. 배속턴 차량이 아닌 경우에는 표시되지 않습니다.

&#x20;![](../../.gitbook/assets/icon-square-6-6.svg) **차량 치수**

* 차량 치수 입력 완료 여부를 표시합니다. 선택 시 차량 치수를 수정할 수 있습니다.

&#x20;![](../../.gitbook/assets/icon-square-7.svg) **차량 보정 유무**
