...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/W9zolTVOCJkGCWFEPCa0/ion/driving-convenience-function/bringing-up-path
---
...
{% stepper %}
{% step %}
取り込みたい経路の <img src="../../../.gitbook/assets/ic_more (2).svg" alt="" data-size="original"> アイコンをタップします。
...
{% stepper %}
{% step %}
削除したい経路の <img src="../../../.gitbook/assets/ic_more (2).svg" alt="" data-size="original"> アイコンをタップします。
