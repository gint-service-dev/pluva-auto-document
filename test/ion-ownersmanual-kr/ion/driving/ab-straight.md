...
metaLinks:
  alternates:
    - /broken/spaces/cB5Egkzinglp2WYUeNhf/pages/pMgMOUYtTr3Zpc0qQTSV
---
...
<div align="left"><figure><img src="../../../.gitbook/assets/ab-straight-forward (1).png" alt="" width="200"><figcaption></figcaption></figure></div>

{% stepper %}
{% step %}
<img src="../../../.gitbook/assets/a-button (1).svg" alt="" data-size="original"> 버튼을 눌러 A 지점을 생성합니다.

<figure><img src="../../../.gitbook/assets/ab-straight-explanation-1 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
10m 이상 직진 주행한 뒤, 원하는 지점에서 <img src="../../../.gitbook/assets/b-button (1).svg" alt="" data-size="original"> 버튼을 눌러 B 지점을 생성합니다.

<figure><img src="../../../.gitbook/assets/ab-straight-explanation-2 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
AB 직진 경로가 생성되면<img src="../../../.gitbook/assets/drive-button (1).svg" alt="" data-size="original">\[자율주행 시작] 버튼을 눌러 자율주행을 시작합니다.
...
{% stepper %}
{% step %}
AB 직진 모드에서, <img src="../../../.gitbook/assets/automatic-path-button (1).svg" alt="" data-size="original"> **\[AB 라인 자동 생성 버튼]**&#xC744; 누릅니다.
...
{% step %}
<img src="../../../.gitbook/assets/drive_ai-button (1).svg" alt="" data-size="original">**\[자율주행]**&#xBC84;튼을 누르면 생성된 경로를 따라 주행이 시작됩니다.
