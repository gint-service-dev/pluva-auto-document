...
<figure><img src="../../../.gitbook/assets/enter-network-settings-1 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="../../../.gitbook/assets/enter-network-settings-3 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<div align="left"><figure><img src="../../../.gitbook/assets/enter-network-settings-screen (1).png" alt=""><figcaption></figcaption></figure></div>
...
*   시스템이 현재 환경에서 가장 좋은 위성을 자동으로 선택합니다. 신호 상태가 좋지 않다면 안내 문구에 따라 조치합니다.<br>
    ...
    <figure><img src="../../../.gitbook/assets/bad-network-condition (1).png" alt=""><figcaption></figcaption></figure>

![](<../../../.gitbook/assets/icon-square-2 (1).svg>) **위치 보정**

* RTK 직접 수신/RTK 블루투스 등 보정 방식과 연결 방법을 설정합니다.\
  자세한 내용은 [위치 보정 설정](rtk-setting.md)을 참고하세요.

![](<../../../.gitbook/assets/icon-square-3 (1).svg>) **네트워크**
