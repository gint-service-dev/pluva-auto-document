...
![](<../../.gitbook/assets/icon-square-3 (1).svg>) **필드 정보**

* 작업이 이루어진 필드 이름을 표시합니다.

![](<../../.gitbook/assets/icon-square-4 (1).svg>) **작업 주소**

* 작업이 이루어진 필지의 주소를 표시합니다.

![](<../../.gitbook/assets/icon-square-5 (1).svg>) **작업 정보**

* 작업 이름, 시작·종료 시각, 순수 작업시간, 작업 면적을 표시합니다.

![](<../../.gitbook/assets/icon-square-6 (1).svg>) **작업 상태 태그**
...
![](<../../.gitbook/assets/icon-square-7 (1).svg>) **장비 정보**

* 해당 작업에 사용된 차량 및 작업기 정보입니다.

![](<../../.gitbook/assets/icon-square-8 (1).svg>) **날씨 정보**
