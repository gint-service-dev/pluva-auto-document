...
{% stepper %}
{% step %}
![](<../../../.gitbook/assets/ic_vehicle (1).svg>) \[차량] 버튼을 누릅니다.
...
<figure><img src="../../../.gitbook/assets/tractor-handle-range-2 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
안내에 따라 핸들을 오른쪽으로 끝까지 돌린 후 차량을 멈추고 \[확인] 버튼을 누릅니다.

<figure><img src="../../../.gitbook/assets/tractor-handle-range-3 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
안내에 따라 핸들을 이용하여 바퀴를 중앙에 위치시키고 차량을 멈추고 \[확인] 버튼을 누릅니다.

<figure><img src="../../../.gitbook/assets/tractor-handle-range-4 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
핸들 범위 보정 완료됩니다.

<figure><img src="../../../.gitbook/assets/leeangi-handle-range-5 (1) (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
{% step %}
![](<../../../.gitbook/assets/drive-button (1).svg>)버튼을 눌러 1차 직진 조향 보정을 시작합니다.
...
<figure><img src="../../../.gitbook/assets/calibration-speed-7 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
{% step %}
![](<../../../.gitbook/assets/drive-button (1).svg>)버튼을 눌러 2차 직진 조향 보정을 시작합니다.

<figure><img src="../../../.gitbook/assets/calibration-speed-9 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
