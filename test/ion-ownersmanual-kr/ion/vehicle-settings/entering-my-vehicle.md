...
![](<../../../.gitbook/assets/icon-square-3 (1).svg>) **GNSS 수신기 설정**

* 차량에 설치된 GNSS 수신기의 위치를 입력하여 위치 정확도를 최적화합니다.

![](<../../../.gitbook/assets/icon-square-4 (1).svg>) **차량 정보**

* 현재 장착된 차량의 타입, 별칭, 브랜드, 모델을 보여줍니다.

![](<../../../.gitbook/assets/icon-square-5 (1).svg>) **배속턴 ON/OFF**

* 배속턴 차량의 배속턴 설정 ON/OFF 상태를 표시합니다. 배속턴 차량이 아닌 경우에는 표시되지 않습니다.

![](<../../../.gitbook/assets/icon-square-6 (1).svg>) **차량 치수**

* 차량 치수 입력 완료 여부를 표시합니다. 선택 시 차량 치수를 수정할 수 있습니다.

![](<../../../.gitbook/assets/icon-square-7 (1).svg>) **차량 보정 유무**
