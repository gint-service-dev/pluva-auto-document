...
{% hint style="info" %}
<img src="../../../.gitbook/assets/ic_circle_help (1).svg" alt="" data-size="line">아이콘을 누르면 해당 기능에 대한 설명을 볼 수 있습니다.
{% endhint %}
...
{% stepper %}
{% step %}
고급 설정 <img src="../../../.gitbook/assets/ic_arrow_tiny (1).svg" alt="" data-size="line"> 을 눌러 고급 설정 기능을 사용할 수 있습니다.
