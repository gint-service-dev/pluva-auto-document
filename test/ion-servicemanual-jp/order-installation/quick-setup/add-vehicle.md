...
metaLinks:
  alternates:
    - /broken/spaces/YgZGmmCCfllSmVLHO3Uz/pages/1UG61CYqsMi6iaZc7xrR
---
...
{% hint style="info" %}
設定された車両の寸法は、タブレットの車両管理メニューから確認及び変更が可能です。
{% endhint %}
...
![](<../../../.gitbook/assets/icon-square-1 (2).svg>) ホイールベース
...
![](<../../../.gitbook/assets/icon-square-3 (2).svg>) 地面 - トップリンク
