...
![](<../../.gitbook/assets/icon-square-1 (2).svg>) アカウント名

![](<../../.gitbook/assets/icon-square-2 (2).svg>) 所属部署および作成日

![](<../../.gitbook/assets/icon-square-3 (2).svg>) アカウント情報
...
![](<../../.gitbook/assets/icon-square-4 (2).svg>) メモ

* **⋮ ボタン**をクリックし、内容を修正及び削除できます。
* **作成者名**と**作成日時**が併せて表示されます。

![](<../../.gitbook/assets/icon-square-5 (2).svg>) アカウントの詳細情報
...
![](<../../.gitbook/assets/icon-square-2 (2).svg>) 所属部署及び作成日
