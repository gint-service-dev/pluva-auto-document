...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/YgZGmmCCfllSmVLHO3Uz/others/operator-management
---
...
![](<../../.gitbook/assets/icon-square-2 (2).svg>) 名前

![](<../../.gitbook/assets/icon-square-3 (2).svg>) 「詳細をみる」ボタン

{% hint style="info" %}
ボタンを押すと、\[修正]、\[無効化]（または、\[有効化]）オプションを選択できます。
{% endhint %}

![](<../../.gitbook/assets/icon-square-4 (2).svg>) 担当

![](<../../.gitbook/assets/icon-square-5 (2).svg>) 作成日

![](<../../.gitbook/assets/icon-square-6 (2).svg>) メールアドレス

![](<../../.gitbook/assets/icon-square-7 (2).svg>) 携帯電話番号

![](<../../.gitbook/assets/icon-square-8 (2).svg>) 部署名
