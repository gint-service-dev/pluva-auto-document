...
metaLinks:
  alternates:
    - /broken/spaces/256Umh24fJVf6zNkZpSa/pages/pKq1PCqWofFMVP6yQfai
---
...
<figure><img src="../../../.gitbook/assets/quick-setup-cellular-1 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
APN이 자동으로 연결됩니다

<figure><img src="../../../.gitbook/assets/quick-setup-cellular-2 (1).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/quick-setup-cellular-3 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
| 정상                                 | 미연결 시              |
| ---------------------------------- | ------------------ |
|  셀룰러(LTE) 아이콘 표시 및 서버/RTK 연결 정상 동작 |  신호 없음 표시 → 2단계 진행 |
{% endstep %}
...
| 정상                  | 미연결 시              |
| ------------------- | ------------------ |
|  셀룰러(LTE) 연결 아이콘 표시 |  신호 없음 표시 → 3단계 진행 |
{% endstep %}
...
| 정상                 | 미연결 시                                                             |
| ------------------ | ----------------------------------------------------------------- |
|  셀룰러(LTE) 연결 정상 표시 | <p> 신호 없음 표시 → 4단계 진행<br>USIM 불량 시: 통신사 문의 또는 USIM 교체 후 대응 종료</p> |
{% endstep %}
...
<figure><img src="../../../.gitbook/assets/quick-setup-wifi-1 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
Wi-Fi 토글을 켭니다.

<figure><img src="../../../.gitbook/assets/quick-setup-wifi-2 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
연결할 Wi-Fi를 선택합니다.

<figure><img src="../../../.gitbook/assets/quick-setup-wifi-3 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
\[다음 단계로] 버튼을 누르면 네트워크 설정이 완료됩니다.

<figure><img src="../../../.gitbook/assets/quick-setup-wifi-4 (1).png" alt=""><figcaption></figcaption></figure>
