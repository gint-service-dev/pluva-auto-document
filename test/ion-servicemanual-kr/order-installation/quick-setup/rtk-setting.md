...
<figure><img src="../../../.gitbook/assets/quick-setup-rtkdirect-1 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
기지국/서버 정보를 입력한 뒤 \[연결]을 누릅니다.

<figure><img src="../../../.gitbook/assets/quick-setup-rtkdirect-2 (1).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/quick-setup-rtkdirect-3 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}

{% hint style="info" %}
고객이 사전에 RTK 계정을 발급받도록 안내합니다. 계정 정보를 잊었다면, 신청서에 기재한 이메일로 로그인해 가입 당시 수신한 메일을 확인하도록 안내합니다.
{% endhint %}
...
<figure><img src="../../../.gitbook/assets/quick-setup-rtkbluetooth-1 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
아래 절차에 따라 외부 앱에서 RTK 블루투스 연결 설정을 진행합니다.

1. 스마트폰에서 블루투스(Bluetooth)를 켭니다.
2. 스마트폰에서 RTK 외부 앱을 실행합니다.
3. 앱 설정에서 기지국 신호 입력 방식을 Bluetooth(블루투스)로 선택합니다.
4. 플루바 아이온을 사용 가능한 디바이스 목록에서 선택합니다.
5. 비밀번호를 입력해 페어링을 완료합니다.
6. 앱 또는 스마트폰의 블루투스 화면에서 연결됨 상태인지 확인합니다.
{% endstep %}

{% step %}
\[다음 단계로] 버튼을 누르면 RTK 블루투스 설정이 완료됩니다.

<figure><img src="../../../.gitbook/assets/quick-setup-rtkbluetooth-2 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}

#### RTK 블루투스 연결 유의사항

플루바 아이온의 정확한 자율조향을 위해서는 작업 중 외부 앱이 계속 작동되어야 한다. RTK가 잡히지 않을 경우 가장 먼저 외부 앱이 꺼져 있는지 확인합니다.
