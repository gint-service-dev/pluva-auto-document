...
<figure><img src="../../.gitbook/assets/account-management-menu-open-1 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
원하는 계정 항목을 선택하면 계정 상세 진입이 완료됩니다.

<figure><img src="../../.gitbook/assets/account-management-menu-select-1 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<figure><img src="../../.gitbook/assets/account-management-detail-pc-1 (1).png" alt=""><figcaption></figcaption></figure>

![](<../../.gitbook/assets/icon-square-1 (3).svg>) 계정 이름

![](<../../.gitbook/assets/icon-square-2 (3).svg>) 소속 대리점 및 생성일

![](<../../.gitbook/assets/icon-square-3 (3).svg>) 계정 정보
...
![](<../../.gitbook/assets/icon-square-4 (3).svg>) 메모

* **⋮ 버튼**을 눌러 내용을 수정하거나 삭제할 수 있습니다.
* **작성자 이름**과 **작성 일시**가 함께 표시됩니다.

![](<../../.gitbook/assets/icon-square-5 (3).svg>) 계정 상세 정보
...
<figure><img src="../../.gitbook/assets/account-management-detail-mobile-1 (1).png" alt="" width="287"><figcaption></figcaption></figure>
