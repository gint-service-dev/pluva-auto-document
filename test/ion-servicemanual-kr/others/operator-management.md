...
<figure><img src="../../.gitbook/assets/operator-management-menu-select-1 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<figure><img src="../../.gitbook/assets/operator-management-account-add-3 (1).png" alt=""><figcaption></figcaption></figure>
...
{% stepper %}
{% step %}
오퍼레이션 상세에서 ![](<../../.gitbook/assets/ic_more (1).svg>)버튼을 누르고 \[수정]을 누릅니다.
...
<figure><img src="../../.gitbook/assets/operator-management-account-edit-3 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
{% stepper %}
{% step %}
오퍼레이터 상세에서 ![](<../../.gitbook/assets/ic_more (1).svg>)버튼을 누르고 \[비활성화]를 누릅니다.

<figure><img src="../../.gitbook/assets/operator-management-account-status-toggle-1 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
확인 팝업에서 \[확인] 버튼을 누릅니다.

<figure><img src="../../.gitbook/assets/operator-management-account-status-toggle-2 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
비활성화가 완료됩니다.

<figure><img src="../../.gitbook/assets/operator-management-account-status-toggle-3 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
<figure><img src="../../.gitbook/assets/operator-management-account-active (1).png" alt=""><figcaption></figcaption></figure>
...
![](<../../.gitbook/assets/icon-square-1 (3).svg>) 상태

![](<../../.gitbook/assets/icon-square-2 (3).svg>) 이름

![](<../../.gitbook/assets/icon-square-3 (3).svg>) 더보기 버튼

{% hint style="info" %}
버튼을 누르면 \[수정], \[비활성화] (또는 \[활성화]) 옵션을 선택할 수 있습니다.
{% endhint %}

![](<../../.gitbook/assets/icon-square-4 (3).svg>) 역할

![](<../../.gitbook/assets/icon-square-5 (3).svg>) 생성일

![](<../../.gitbook/assets/icon-square-6 (3).svg>) 이메일

![](<../../.gitbook/assets/icon-square-7 (3).svg>) 휴대폰 번호

![](<../../.gitbook/assets/icon-square-8 (3).svg>) 조직명

{% hint style="info" %}
조직명을 클릭하면 해당 조직의 상세 화면으로 이동합니다.
{% endhint %}

![](<../../.gitbook/assets/icon-square-9 (1).svg>) 태그

* 조직에 대한 정보를 표시합니다.

#### 모바일 환경

<div align="left"><figure><img src="../../.gitbook/assets/operator-management-account-detail-mobile-1 (1).png" alt="" width="273"><figcaption></figcaption></figure></div>
