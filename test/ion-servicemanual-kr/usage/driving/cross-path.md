...
<div align="left"><figure><img src="../../../.gitbook/assets/cross-path (1) (1).png" alt="" width="189"><figcaption></figcaption></figure></div>
...
<figure><img src="../../../.gitbook/assets/cross-path-boundary-point-setup-1 (2).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="../../../.gitbook/assets/cross-path-boundary-point-setup-2 (2).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="../../../.gitbook/assets/cross-path-boundary-point-setup-3 (2).png" alt=""><figcaption></figcaption></figure>
...
<img src="../../../.gitbook/assets/cross-path-adjustment (2).png" alt="" data-size="original">
{% endhint %}
{% endstep %}
...
<figure><img src="../../../.gitbook/assets/cross-path-boundary-point-setup-4 (2).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
격자 라인 생성이 완료되면 작업 경로를 설정하고 \[주행 시작]을 누릅니다.

<figure><img src="../../../.gitbook/assets/cross-path-boundary-point-setup-6 (2).png" alt=""><figcaption></figcaption></figure>
...
* **선택 가능:** ![](<../../../.gitbook/assets/path-default (3).png>)
* **선택 불가능:** ![](<../../../.gitbook/assets/path-disabled (3).png>)
* **선택 됨:** ![](<../../../.gitbook/assets/path-selected (3).png>)
{% endhint %}
