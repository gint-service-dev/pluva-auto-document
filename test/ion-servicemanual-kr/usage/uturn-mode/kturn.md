...
<figure><img src="../../../.gitbook/assets/kturn-mode-1 (2).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
![](<../../../.gitbook/assets/drive-button (3).svg>)\[자율 주행 시작] 버튼을 누르고 K턴 지점에 도달하면 즉시 작업기를 올리세요.

<figure><img src="../../../.gitbook/assets/kturn-mode-2 (2).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
전진 기어를 유지한 상태로 차량이 방향을 전환합니다.

<figure><img src="../../../.gitbook/assets/kturn-mode-3 (2).png" alt=""><figcaption></figcaption></figure>
{% endstep %}

{% step %}
방향 전환이 완료되면, 차량을 다음 작업 진입 라인까지 후진합니다.

<figure><img src="../../../.gitbook/assets/kturn-mode-4 (2).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/kturn-mode-5 (2).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/kturn-mode-6 (2).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
