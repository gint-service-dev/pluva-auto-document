...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/4rNrDNCqOFVCh006UOXy/ion/network-settings/rtk-setting
---
...
![](../../.gitbook/assets/icon-square-2-2.svg) **RTK 직접 수신 연결**
...
![](../../.gitbook/assets/same_server.png)
{% endhint %}
{% endstep %}
