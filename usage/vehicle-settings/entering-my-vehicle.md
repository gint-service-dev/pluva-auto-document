...
![](<../../.gitbook/assets/icon-square-1-1 (2).svg>) **車両補正**

* 車両が揺れたり曲がったりせず、正確に直進できるようオートステア、ロール・ピッチ・ヨー、慣性センサーなどを補正します。

![](<../../.gitbook/assets/icon-square-2-2 (2).svg>) **車両の制御設定**

* 作業環境に合わせて走行の特性を調整できます。\
  設定変更すると自動操舵の性能に影響を与えかねません。

![](<../../.gitbook/assets/icon-square-3-3 (2).svg>) **GNSS受信機の設定**

* 車両に取り付けられたGNSS受信機の位置を入力し、位置精度を最適化できます。（または位置精度を高められます。）

![](<../../.gitbook/assets/icon-square-4-4 (2).svg>) **車両情報**

* 取り付けられている車両のタイプ、別名、メーカー、機種を表示します。

![](<../../.gitbook/assets/icon-square-5-5 (2).svg>) **倍速ターン ON/OFF**

* 倍速ターン付きの車両の場合、車両の倍速ターンのON/OFF状態を表示します。倍速ターン付きの車両でない場合には表示されません。

![](<../../.gitbook/assets/icon-square-6-6 (2).svg>) **車両寸法**

* 車両の寸法を入力し終わったかどうかが表示されます。タップすると車両の寸法を変更できます。

![](<../../.gitbook/assets/icon-square-7 (1).svg>) **車両補正の有無**
