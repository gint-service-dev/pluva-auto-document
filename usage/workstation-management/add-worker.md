...
{% step %}
![](<../../.gitbook/assets/add-button (1).svg>) 作業機の追加ボタンをタップします。
...
<figure><img src="../../.gitbook/assets/add-worker-5 (1).png" alt=""><figcaption></figcaption></figure>
{% endstep %}
{% endstepper %}
...
![](<../../.gitbook/assets/icon-square-1-1 (2).svg>) 作業機タイプ

* 作業機タイプを選択します。

![](<../../.gitbook/assets/icon-square-2-2 (2).svg>) 作業機の幅

* 作業機の幅を入力します。

![](<../../.gitbook/assets/icon-square-3-3 (2).svg>) 畝間

* 畝間を入力します。

![](<../../.gitbook/assets/icon-square-4-4 (2).svg>) リンク -作業機の距離

* リンクと作業機の間の距離を入力します。

![](<../../.gitbook/assets/icon-square-5-5 (2).svg>) 作業機の偏差

* 作業機の偏差を入力します。

![](<../../.gitbook/assets/icon-square-6-6 (2).svg>) 作業機偏差の計算
